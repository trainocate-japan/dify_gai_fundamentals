...
ユーザーからの社内問い合わせを入力すると、AIが内容を「人事」「情シス」「総務」の適切な部署に自動で振り分け、各部署の専門ナレッジから最適な回答を生成するワークフローです。
...
1. **result_human**：`LLM_人事 text`
2. **result_it**：`LLM_情シス text`
3. **result_general**：`LLM_総務 text`
